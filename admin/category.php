...
<body class="hold-transition sidebar-mini layout-fixed">
                     ...
                     <table id="example1" class="table">
                        ...
                        <tbody>
                           <?php
                              ...
                              <td>'.$row['isTabulated'].'</td>
                              <td><span class="badge bg-green">'.$row['percentage'].'% </span></td>
                              <td class="text-center">
                                 ...
                                 echo '<center>No Event Category Data found</center>';
                              }
                           ?>
   ...
   <div id="active" class="modal animated rubberBand delete-modal" role="dialog">
      <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content">
            <div class="modal-body text-center">
               <img src="../asset/img/sent.png" alt="" width="50" height="46">
               <h3>Are you sure want to make this Category Ready?</h3>
               <div class="m-t-20">
                     <form action="backend/change_category.php" method="POST">
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-12">
                                 <div class="form-group">
                                    ...
                                    <input type="number" name="percentage" class="form-control" placeholder="Final Scoring Perecentage">
                                 </div>
                              </div>
                              <div class="col-md-12">
                                 <div class="form-group">
   ...
   <script>
      $(document).on("click", ".open-SetActiveDialog", function () {
