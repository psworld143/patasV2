...
import 'package:patasv2/screens/top5scoresheets.dart';

class Top5Contestant extends StatelessWidget {
  @override
  ...
  Widget buildContestantBox(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Top5Scoresheets()), // Navigate to ScoreSheets
        );
      },
      child: Container(
        decoration: BoxDecoration(
